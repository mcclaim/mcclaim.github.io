(function (root, factory) {
    ...
    function buildUI(title, sub, onOk, onCancel, type) {
        ...
        var content = ce('div', 'msc-content'),
            ...
            okBtn = ce('button', 'btn btn-danger', options.okText),
            cancelbtn = ce('button', 'btn btn-info', options.cancelText),
    ...
    var exportData = {
        msConfirm: function(title, sub, onOk, onCancel) {
            buildUI(title, sub, onOk, onCancel, "confirm");
        },
        msPrompt: function(title, sub, onOk, onCancel) {
            buildUI(title, sub, onOk, onCancel, "prompt");
        },
        msAlert: function(title, sub, onOk, onCancel) {
